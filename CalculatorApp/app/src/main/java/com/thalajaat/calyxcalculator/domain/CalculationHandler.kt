...
//    private fun handlePercentage(value: String) {
//        val lastOperation = lastOperation?:""
//        val baseValue = findLastNumberBeforePercentage(expression.value)
//
//        when (lastOperation) {
//            "+", "-" -> {
//                val percentageValue = baseValue * (value.replace("%", "").toDouble() / 100)
//                expression.value = expression.value.dropLast(1) + percentageValue.toString()
//            }
//            "*", "/" -> {
//                val decimalValue = value.replace("%", "").toDouble() / 100
//                expression.value += decimalValue.toString()
//            }
//            else -> expression.value += value // No operation found, add as is
//        }
//        calculateExpression()
//    }
    ...
    fun convertPercentageExpressions(expression: String): String {
        ...
        Log.d("Expression IS", expression)
        return value;
    }
}
